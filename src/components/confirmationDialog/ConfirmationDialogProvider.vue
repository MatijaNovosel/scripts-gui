  ...
  <div class="display-contents">
    ...
    >
      <v-card class="pt-3">
        ...
        >
          <div>
            <v-icon :color="state.options.type" size="80">
              {{
          ...
          <div class="pl-4">
            ...
            <div v-show="!!state.options.content" class="text-subtitle-1 pt-5 pb-6">
        ...
        <v-card-actions class="py-3 justify-end pr-5">
          <v-btn
            ...
            text="No"
          />
          <v-btn color="success" variant="flat" rounded="4" @click="agree" text="Yes" />
        </v-card-actions>
      </v-card>
    </v-dialog>
  </div>
